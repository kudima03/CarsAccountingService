    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable("AspNetUsers",
                                     table => new
                                     {
                                         ...
                                         CardNumber = table.Column<string>("nvarchar(max)", nullable: false),
                                         SecurityNumber = table.Column<string>("nvarchar(max)", nullable: false),
                                         Expiration = table.Column<string>("nvarchar(max)", nullable: false),
                                         CardHolderName = table.Column<string>("nvarchar(max)", nullable: false),
                                         CardType = table.Column<int>("int", nullable: false),
